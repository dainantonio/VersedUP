...
function HomeView({ onNew, onLibrary, onContinue, onReflectVerseOfDay, hasActive, streak, greetingName }) {
  return (
      ...
      <div className="sticky top-0 z-30 bg-white/70 backdrop-blur-xl border-b border-slate-200/70 px-4 py-3">
        <div className="max-w-md mx-auto flex items-center gap-3">
          ...
          <div className="min-w-0 leading-tight flex-1">
            ...
            <div className="text-[11px] font-bold text-slate-500">{session?.mode === "guest" ? "Guest session" : `Signed in as ${session?.name || "Friend"}`}</div>
          </div>
          <button
            type="button"
        ...
        <div className="max-w-md mx-auto px-4 pb-4">
          <div className="bg-white/55 backdrop-blur-2xl border border-slate-200/70 shadow-[0_18px_60px_-25px_rgba(0,0,0,0.35)] rounded-3xl px-3 py-2">
            <div className="flex items-center gap-2">
              ...
              <div className={cn("grid gap-2 flex-1", navCollapsed ? "grid-cols-4" : "grid-cols-4")}>
