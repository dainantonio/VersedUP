    ...
    <div className="space-y-6 pb-24">
      ...
      <Card themeKey={themeKey}>
        <div className="space-y-4">
          ...
          <InputGroup themeKey={themeKey} label="Verse Text" placeholder="Paste scripture here..." value={activeDevotional.verseText} onChange={(val) => updateDevotional('verseText', val)} multiline />
        </div>
      </Card>
      ...
      <Card themeKey={themeKey}>
        ...
        <div className="mt-4">
          <InputGroup themeKey={themeKey} label="Your Thoughts" placeholder="What is God speaking through this? Don't worry about grammar." value={activeDevotional.rawText} onChange={(val) => updateDevotional('rawText', val)} multiline />
        </div>
      </Card>
  ...
  return (
    <div className="space-y-6 pb-24">
      ...
      <div className="text-center pt-8">
        <p className={`text-xs ${theme.subTextColor} mb-2`}>VersedUP v1.2.0 (Theme Edition)</p>
